package com.learning.pattern.createPattern.singletonPattern.Summary;
...
public class HungryInnerClassSingleton {
    ...
    private static class SingletonHolder {
        ...
        private static final HungryInnerClassSingleton INSTANCE = new HungryInnerClassSingleton();
    ...
    public static final HungryInnerClassSingleton getInstance() {
